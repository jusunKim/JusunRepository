...
public class ReviewDAO {
	...
	//reviewDAO
	public HashMap<String, Object> detailAllReview(int reno){
			String sql = "select nickname, re_title, re_content, rating, re_date, r.reno from "
					+ " review r, users u where r.uno=u.uno and r.reno="+reno
