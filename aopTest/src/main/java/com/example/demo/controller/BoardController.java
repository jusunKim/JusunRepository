...
public class BoardController {
	...
	public void listBoard(HttpServletRequest request, @RequestParam(value = "pageNo", defaultValue = "1") int pageNo, Model model) {
...
//		}
	...
	public void detailBoard(HttpServletRequest request, int no, Model model) {
