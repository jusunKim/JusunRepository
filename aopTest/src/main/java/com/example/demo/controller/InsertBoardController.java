...
public class InsertBoardController {
	...
	@GetMapping
	 public void insertBoard(HttpServletRequest request, String no, Model model) { //--> 매개변수로 받은 no는 request.getparameter와 동일한 역할이라서 int로 받지 못하기 때문에 String으로 일단 받는다.
	...
	@PostMapping
	public String submit(HttpServletRequest request, BoardVO b) {
