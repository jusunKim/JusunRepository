...
var bod = require("./bookOracleDAO");


app.get("/listBook", async function(req,res){ //
    var arr = await bod.listBook();
    res.send(arr);
})

app.post("/insertBook", async function(req, res) {
    var doc = req.body;
    var re = await bod.insertBook(doc);
  ...
  app.post("/updateBook",async function(req,res){
    var doc = req.body;
    var re = await bod.updateBook(doc);
    res.send(re+"");
  })
  ...
  app.post("/deleteBook",async function(req,res){
    ...
    var re = await bod.deleteBook(bookid);
    res.send(re+"")
  })
