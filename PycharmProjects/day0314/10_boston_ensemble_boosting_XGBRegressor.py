...
model = XGBRegressor( max_depth=3, random_state=20, objective='reg:squarederror')
# objective='reg:squarederror : 학습목적은 오류의 제곱의 합을 줄이는 거야
...
print(train_mse) #3.5328655114397267
print(test_mse) #19.906969834733722
