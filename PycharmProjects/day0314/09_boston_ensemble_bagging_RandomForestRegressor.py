...
#---------------------------------------------------------------
# 회귀모형의 앙상블-배깅이라고 할 수 잇음.
# sklearn.tree.DecisionTreeRegressor
from sklearn.ensemble import RandomForestRegressor
model = RandomForestRegressor(max_depth=3, random_state=20) #의사결정나무 알고리즘의 회귀모델을 생성
...
print(train_mse) #15.539791244348624
print(test_mse) #19.231388998802252
